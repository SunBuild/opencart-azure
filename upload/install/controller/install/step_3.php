...
class ControllerInstallStep3 extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$output .= '// DIR' . "\n";
			$output .= 'define(\'DIR_BASE\', realpath($_SERVER[\'DOCUMENT_ROOT\']) . \'/\');' . "\n";
			$output .= 'define(\'DIR_APPLICATION\', DIR_BASE . \'catalog/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\', DIR_BASE . \'system/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\', DIR_BASE . \'image/\');' . "\n";
			...
			$output .= '// DIR' . "\n";
			$output .= 'define(\'DIR_BASE\', realpath($_SERVER[\'DOCUMENT_ROOT\']) . \'/\');' . "\n";
			$output .= 'define(\'DIR_APPLICATION\', DIR_BASE . \'admin/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\', DIR_BASE . \'system/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\', DIR_BASE . \'image/\');' . "\n";
			$output .= 'define(\'DIR_LANGUAGE\', DIR_APPLICATION . \'language/\');' . "\n";
			...
			$output .= 'define(\'DIR_MODIFICATION\', DIR_STORAGE . \'modification/\');' . "\n";
			$output .= 'define(\'DIR_UPLOAD\', DIR_STORAGE . \'upload/\');' . "\n";
			$output .= 'define(\'DIR_CATALOG\', DIR_BASE . \'catalog/\');' . "\n\n";
